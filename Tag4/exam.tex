...
\begin{tikzpicture}[scale=0.5]
  \draw[step=1cm,gray!30,very thin] (-3.5,-6.5) grid (9.5,9.5);
  \draw[->] (-3.6,0) -- (9.6,0) node[right] {$x$};
  \draw[->] (0,-6.6) -- (0,9.6) node[above] {$y$};
  \foreach \x in {-3,-2,...,9} \draw (\x,0.1) -- (\x,-0.1) node[below=4pt] {\small \x};
  \foreach \y in {-3,-5,...,9} \draw (0.1,\y) -- (-0.1,\y) node[left=4pt] {\small \y};
\end{tikzpicture}
\end{center}
